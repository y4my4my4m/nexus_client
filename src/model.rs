        ...
        Forum {
            ...
            threads: vec![
                ...
                Thread {
                    ...
                    posts: vec![
                        Post { author: "n0de_r-unner".to_string(), content: "Every time I get close to their mainframe, the system adapts. It's not just scripts; it feels like it's learning. Anyone else seeing this?".to_string() },
                    ],
                },
            ],
        },
        ...
        Forum {
            ...
            threads: vec![
                 Thread {
                    ...
                    posts: vec![
                        Post { author: "audiophile".to_string(), content: "Their latest album is a banger. The way they mix synth with feedback from malfunctioning cybernetics is art.".to_string() },
                        Post { author: "Cyph3r".to_string(), content: "It's all corporate noise, man. Wake up.".to_string() },
                    ],
                },
            ],
        },
